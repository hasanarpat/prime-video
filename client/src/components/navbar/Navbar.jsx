  ...
  return (
    <nav
      className={classNames(
        'w-full h-14 sticky top-0 transition-all duration-200 bg-main z-50',
        scrollPosition > 100 &&
          'md:top-2 md:w-[80%] 2xl:w-[55%] mx-auto md:rounded-xl px-0'
      )}
    >
      <div
        className={classNames(
      ...
      >
        ...
        <div className='h-12 flex items-center'>
          <span className='flex items-center gap-4 whitespace-nowrap ml-4 xl:ml-0 h-full'>
            <svg
              stroke='currentColor'
              fill='currentColor'
              strokeWidth='0'
            ...
            <div
              className={classNames(
                'absolute w-full h-screen bg-secondaryLight top-12 left-0 z-50',
